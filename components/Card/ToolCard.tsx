	...
	return (
		<>
			{tools.map((tool) => (
				...
				>
					<div className="flex-column card-bg relative h-full gap-4 rounded-lg border border-dark-200 p-4 shadow-md transition-transform hover:scale-105 dark:border-light-800">
